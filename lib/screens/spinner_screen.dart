      ...
      /// here we are using stack because we are placing the 20 text on each other
        child: Stack(
          ...
          children:
           ...
           List.generate(numberOfTexts, (index) {
           ...
           return  AnimatedBuilder(
             ...
             builder: (context,child) {
               ...
               final animationRotationValue =
                   _animationController.value * 2 * math.pi / numberOfTexts; //<-- calculate animation rotation value
               ...
               return Transform(
                 alignment: Alignment.center,
                     transform: Matrix4.identity()..setEntry(3, 2, 0.001)..rotateY(rotation)..translate(-120.0),
                     child:child );
             }
           );
