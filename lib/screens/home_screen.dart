...
import 'package:flutter_3d_sipner_text/screens/spinner_screen.dart';
...
/// Here we are Creating the TextEditing Controller to Have more Control on Our TextFeild
  ...
  Widget build(BuildContext context) {
    ...
    bool isnavigate=password.text.length>=6;
            ...
            children: [
              Container(
                margin:const  EdgeInsets.only(top: 20),
                  ...
                  child:const  Text("Welcome",style: TextStyle(color: Colors.white,fontSize: 60,fontWeight: FontWeight.bold),)),
             ...
             const  Spacer(),
              ...
              Container(
                margin:const  EdgeInsets.only(bottom: 20),
                  ...
                  child:const  Text("Enter Text",style: TextStyle(color: Colors.white,fontSize: 30,fontWeight: FontWeight.bold),)),

             /// We are using stack because we are overlaping widgets
              /// at bottom we have textformfeild
            ...
            GestureDetector(
              onTap: (){
                ...
                if(isnavigate){
                  ...
                  Navigator.of(context).push(MaterialPageRoute(builder: (context)=>SpinnerScreen(password.text.toString())));
                }
              ...
              child:   Container(
                ...
                child:  Text("SPIN TEXT",style: TextStyle(color:isnavigate? Colors.black:Colors.white,fontWeight: FontWeight.bold,fontSize: 20),),
              ),
            ),
              Spacer(),
            ],
